  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Wrap(
        ...
        runSpacing: 10,
        children: const [
          _LegendItem(color: Color(0xFFFFCC80), label: '행복'),
          _LegendItem(color: Color(0xFF81D4FA), label: '차분'),
          _LegendItem(color: Color(0xFFA5D6A7), label: '안정'),
          _LegendItem(color: Color(0xFFFFAB91), label: '피곤'),
        ],
      ),
    );
  }
